-- | The foundation "Blink.View.Layout.Box" and "Blink.View.Layout.Border" are both
...
module Blink.View.Layout.Constraints
  ( Length
  , exactly
  , fill
  , atLeast
...
--   unless something further up the tree (such as 'Blink.View.Layout.Box.hBox' or
--   'Blink.View.Layout.Box.vBox') clips it.
--
-- @
...
-- >  |                            |    Badge    |
-- >  +----------------------------+-------------+
layoutWithConstraints :: Layout -> View e msg a -> View e msg a
...
-- 'Blink.View.Layout.Box.preferredSizes'.
...
-- infinite when it has no ceiling. See 'Blink.View.Layout.Box.distributeSurplusSpace'.
