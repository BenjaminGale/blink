...
-- 'Blink.View.Element.Element'), including how it behaves on the cross axis:
...
--   own 'Blink.View.Layout.Layout' governing its width and, on the cross axis
...
--     within its slot according to its own 'Blink.View.Layout.Layout' -- a 'fill'
...
--   own 'Blink.View.Layout.Layout' governing its height and, on the cross axis
...
-- 'naturalLength'.
boxSlots :: Axis -> BoxConfig e msg -> MeasureCtx -> View e msg [Double]
...
boxMeasure :: Axis -> BoxConfig e msg -> MeasureCtx -> View e msg Size
...
-- 'boxSlots'.
measureCrossExtent :: Axis -> BoxConfig e msg -> MeasureCtx -> View e msg Double
...
runBox :: Axis -> BoxConfig e msg -> View e msg ()
runBox ax cfg = do
  r <- getBounds
  let kids        = bxChildren cfg
