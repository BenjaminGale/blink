...
module Blink.View.Layout.Border
  ( borderLayout
  , BorderContent
  , emptyBorderContent
  , top
...
--
-- No spacing or margin is applied. Clipping follows 'Blink.View.Layout.Box.vBox' and
-- 'Blink.View.Layout.Box.hBox': the top, middle, and bottom rows are clipped as a
