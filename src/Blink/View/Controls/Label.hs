...
-- content is a plain caption (see 'Blink.View.Controls.Button.button', 'label').
...
-- -- unlike 'Blink.View.Controls.Button.button', a label is often placed beside
...
-- Override with 'Blink.View.Layout.Constraints.width'\/'Blink.View.Layout.Constraints.height'\/'Blink.View.Layout.Constraints.align'.
