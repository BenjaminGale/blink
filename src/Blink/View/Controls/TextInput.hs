...
import Blink.View.Controls.Label (captionElement)
...
-- into. Override with 'Blink.View.Layout.Constraints.width'\/'Blink.View.Layout.Constraints.height'\/'Blink.View.Layout.Constraints.align'.
