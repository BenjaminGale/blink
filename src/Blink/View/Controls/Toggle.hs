...
-- (see "Blink.View.Controls.Checkbox") does too, drawing a checkmark glyph
-- beside its caption; a radio button (see "Blink.View.Controls.RadioButton")
...
import Blink.View.Style (VisualState (..))
...
-- override for this on its own 'Blink.View.Style.StyleSet' (keyed to whatever 'StyleKey'
...
-- | Runs @cfg@ as 'Blink.View.Controls.Button.buttonBase', and additionally fires
...
-- | A button labelled via 'Blink.View.Controls.Label.text' that tracks an external selected\/unselected
...
-- while selected -- see "Blink.View.Style" for how a theme gives that a
-- distinct look. Activated the same way as 'Blink.View.Controls.Button.button';
...
-- same as 'Blink.View.Controls.Button.button'; override with 'Blink.View.Layout.Constraints.width'\/'Blink.View.Layout.Constraints.height'\/'Blink.View.Layout.Constraints.align'.
