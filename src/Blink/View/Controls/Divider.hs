...
-- required.
module Blink.View.Controls.Divider
  ( DividerConfig (..)
...
-- either axis afterwards with 'Blink.View.Layout.Constraints.width'\/
-- 'Blink.View.Layout.Constraints.height' as usual.
...
-- 'Blink.View.Layout.Box.vBox'; 'Vertical' draws one stretching top-to-bottom,
-- for separating things side by side in an 'Blink.View.Layout.Box.hBox'.
...
-- running it along. Defaults to 1. Has no effect if 'Blink.View.Layout.Constraints.width'\/
-- 'Blink.View.Layout.Constraints.height' overrides that axis to something other
-- than 'Blink.View.Layout.Constraints.fitContent'.
...
-- override with 'Blink.View.Layout.Constraints.width'\/'Blink.View.Layout.Constraints.height'\/
-- 'Blink.View.Layout.Constraints.align'; when placed in an 'Blink.View.Layout.Box.hBox'\/
-- 'Blink.View.Layout.Box.vBox' next to a taller\/wider sibling,
-- 'Blink.View.Layout.Constraints.align' picks where within that extra space the
-- line sits.
...
divider attrs = Element
  ...
  where
    ...
    -- see 'Blink.View.Layout.Constraints.resolveLength'.
