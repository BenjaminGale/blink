...
-- while focused. See "Blink.Controls.ToggleButton" for the sibling family of
-- controls that track a selected\/unselected state instead.
--
-- @
-- control --> buttonBase --> button
--                             --> toggleBase  (see "Blink.Controls.ToggleButton")
...
-- it holds focus. The event 'button'\/'Blink.Controls.ToggleButton.toggleButton'\/'Blink.Controls.Checkbox.checkbox'\/
...
-- button-like control ('button', 'Blink.Controls.ToggleButton.toggleButton', and
