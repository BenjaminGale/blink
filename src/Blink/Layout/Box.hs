...
-- 'Blink.Element.Element'), including how it behaves on the cross axis:
...
--   own 'Blink.Layout.Constraints.Layout' governing its width and, on the cross axis
...
--     within its slot according to its own 'Blink.Layout.Constraints.Layout' -- a 'fill'
...
--   own 'Blink.Layout.Constraints.Layout' governing its height and, on the cross axis
