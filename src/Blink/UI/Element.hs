...
-- content-dependent 'Blink.UI.Layout.Constraints.Length' into a concrete
-- number.
...
import Blink.UI.Layout.Constraints
...
-- ('Blink.UI.Layout.Constraints.fitContent', 'Blink.UI.Layout.Constraints.atLeast',
-- 'Blink.UI.Layout.Constraints.between') against the current bounds first --
...
-- container child before it reports its own 'Layout' (see "Blink.UI.Controls").
-- Reports 'noIntrinsicSize', so @layout@ must not name a content-dependent
-- rule ('Blink.UI.Layout.Constraints.fitContent', 'Blink.UI.Layout.Constraints.atLeast',
-- or 'Blink.UI.Layout.Constraints.between') -- there is nothing behind it to
-- measure.
