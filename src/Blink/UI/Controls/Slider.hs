...
-- 'Blink.UI.Controls.Label.LabelledConfig' either. The interactive
-- counterpart to 'Blink.UI.Controls.ProgressBar.progressBar': where a
...
module Blink.UI.Controls.Slider
  ( SliderConfig (..)
  , defaultSliderConfig
  , sliderStyleKey
  , slider
...
-- 'Blink.UI.Controls.ProgressBar.progressBar'; override with
