...
-- (see "Blink.UI.Controls.Checkbox") does too, drawing a checkmark glyph
-- beside its caption; a radio button (see "Blink.UI.Controls.RadioButton")
...
--
-- @
-- controlBase --> buttonBase --> button                    (see "Blink.UI.Controls.Button")
--                             --> toggleBase --> toggleButton
--                                             --> checkbox     (see "Blink.UI.Controls.Checkbox")
--                                             --> radioButton  (see "Blink.UI.Controls.RadioButton")
-- @
module Blink.UI.Controls.Toggle
  ( ToggleConfig (..)
  , ToggleInteraction (..)
...
-- | Runs @cfg@ as 'Blink.UI.Controls.Button.buttonBase', and additionally fires
...
-- | A button labelled via 'Blink.UI.Controls.Label.text' that tracks an external selected\/unselected
...
-- distinct look. Activated the same way as 'Blink.UI.Controls.Button.button';
...
-- same as 'Blink.UI.Controls.Button.button'; override with 'Blink.UI.Layout.Constraints.width'\/'Blink.UI.Layout.Constraints.height'\/'Blink.UI.Layout.Constraints.align'.
