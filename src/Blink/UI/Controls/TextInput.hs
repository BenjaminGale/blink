...
-- 'controlBase'. Its own value isn't a 'Blink.UI.Controls.Label.LabelledConfig'
-- field -- it's edited, not just displayed -- so it has its own 'value'
-- attribute rather than 'Blink.UI.Controls.Label.text'.
module Blink.UI.Controls.TextInput
  ( TextInputConfig (..)
...
import Blink.UI.Controls.Label (captionElement)
...
-- into. Override with 'Blink.UI.Layout.Constraints.width'\/'Blink.UI.Layout.Constraints.height'\/'Blink.UI.Layout.Constraints.align'.
