...
-- while focused. See "Blink.UI.Controls.Toggle" for the sibling family of
-- controls that track a selected\/unselected state instead.
--
-- @
-- controlBase --> buttonBase --> button
--                             --> toggleBase  (see "Blink.UI.Controls.Toggle")
--                             --> repeatButton  (see "Blink.UI.Controls.RepeatButton")
-- @
module Blink.UI.Controls.Button
  ( ButtonConfig (..)
  , ButtonActivation (..)
  , ButtonInteraction (..)
  , HasButtonConfig (..)
...
import Blink.UI.Controls.Label
...
data ButtonActivation
  ...
  | ActivateOnPress
    ...
    -- 'Blink.UI.Controls.RepeatButton.repeatButton'). For the same reason,
    ...
    -- rather than a cadence 'Blink.UI.Controls.RepeatButton.repeatButton'
...
-- the wrapped 'ControlConfig', its caption (see 'Blink.UI.Controls.Label'),
...
-- it holds focus. The event 'button'\/'Blink.UI.Controls.Toggle.toggleButton'\/'Blink.UI.Controls.Checkbox.checkbox'\/
-- 'Blink.UI.Controls.RadioButton.radioButton' actually want callers to bind for "the control was
...
-- button-like control ('button', 'Blink.UI.Controls.Toggle.toggleButton', and
-- 'Blink.UI.Controls.Checkbox.checkbox'\/'Blink.UI.Controls.RadioButton.radioButton') is
...
-- | A clickable button labelled via 'Blink.UI.Controls.Label.text'. Fires every 'onActivated'
...
-- to its own chrome-wrapped caption; override with 'Blink.UI.Layout.Constraints.width'\/'Blink.UI.Layout.Constraints.height'\/'Blink.UI.Layout.Constraints.align'.
