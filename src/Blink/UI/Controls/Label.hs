...
-- 'Blink.UI.Controls.Element.elementBase'\/'Blink.UI.Controls.Control.controlBase'-style
...
-- 'Blink.UI.Controls.Element.ElementConfig'\/'Blink.UI.Controls.Control.ControlConfig'.
...
module Blink.UI.Controls.Label
  ( -- * Caption fragment
    LabelledConfig (..)
  , HasLabelledConfig (..)
...
-- content is a plain caption (see 'Blink.UI.Controls.Button.button', 'label').
...
-- -- unlike 'Blink.UI.Controls.Button.button', a label is often placed beside
...
-- Override with 'Blink.UI.Layout.Constraints.width'\/'Blink.UI.Layout.Constraints.height'\/'Blink.UI.Layout.Constraints.align'.
