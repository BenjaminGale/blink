-- | The foundation "Blink.UI.Layout.Box" and "Blink.UI.Layout.Border" are both
...
module Blink.UI.Layout.Constraints
  ( Length
  , exactly
  , fill
  , atLeast
...
--   unless something further up the tree (such as 'Blink.UI.Layout.Box.hBox' or
--   'Blink.UI.Layout.Box.vBox') clips it.
--
-- @
...
-- 'Blink.UI.Layout.Box.preferredSizes'.
...
-- infinite when it has no ceiling. See 'Blink.UI.Layout.Box.distributeSurplusSpace'.
...
-- pattern as 'Blink.UI.Controls.Control.HasControlConfig'\/
-- 'Blink.UI.Controls.Element.HasElementConfig', minus the @e@\/@msg@
