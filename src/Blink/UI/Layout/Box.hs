...
--   own 'Blink.UI.Layout.Layout' governing its width and, on the cross axis
...
--     within its slot according to its own 'Blink.UI.Layout.Layout' -- a 'fill'
...
--   own 'Blink.UI.Layout.Layout' governing its height and, on the cross axis
