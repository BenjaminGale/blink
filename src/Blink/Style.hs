...
'Blink.Controls.Control.control' already tracks (e.g. a toggle
...
'Custom' values themselves. See "Blink.Controls.ToggleButton" for
...
data VisualState
  ...
  | CommonDisabled   -- ^ Control is inside a 'Blink.View.disableWhen' subtree.
