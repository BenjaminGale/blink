...
-- | The contract for a control whose 'Blink.UI.Controls.Control.isFocusable' is fixed
-- rather than a default -- it always overrides its own value last, so
-- nothing a caller passes can change it (e.g. 'Blink.UI.Controls.Label.label',
-- 'Blink.UI.Controls.ProgressBar.progressBar'). 'Blink.UI.Controls.ControlBehaviour.controlBehaviourSpec'
...
module Blink.UI.Controls.FixedFocusBehaviour
