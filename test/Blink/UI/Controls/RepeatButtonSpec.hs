...
module Blink.UI.Controls.RepeatButtonSpec (spec) where

import qualified Data.Map.Strict as Map
import Test.Hspec

import Blink.UI.Controls.Button (onActivated)
import Blink.UI.Controls.ButtonBehaviour (ButtonBehaviourConfig (..), buttonBehaviourSpec, defaultButtonBehaviourConfig)
import Blink.UI.Controls.Control (elementId)
...
-- the same way 'Blink.UI.Controls.ButtonSpec.fullSize' forces 'button' full
-- for the same reason. 'repeatButton' defaults to fitting its own caption
-- height, same as 'Blink.UI.Controls.Button.button'.
...
-- from the previous frame's 'Blink.UI.Controls.RepeatButton.onFiredCountChanged',
...
spec :: Spec
spec = describe "Blink.UI.Controls.RepeatButton" $ do
  ...
  describe "repeat cadence" $ do
    ...
    -- the previous frame's 'Blink.UI.Controls.RepeatButton.onFiredCountChanged'
