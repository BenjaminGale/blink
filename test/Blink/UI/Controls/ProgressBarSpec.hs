...
module Blink.UI.Controls.ProgressBarSpec (spec) where

import qualified Data.Map.Strict as Map
import Test.Hspec

import Blink.UI.Controls.Element (Attribute, elementId)
...
import Blink.UI.Controls.ProgressBar (ProgressBarConfig, ProgressValue (..), bandSpeed, progress, progressBar)
...
spec :: Spec
spec = describe "Blink.UI.Controls.ProgressBar" $ do
