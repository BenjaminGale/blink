...
-- 'Blink.UI.Controls.ButtonBehaviour.buttonBehaviourSpec'). 'Blink.UI.Controls.Toggle.toggleButton',
-- 'Blink.UI.Controls.Checkbox.checkbox', and 'Blink.UI.Controls.RadioButton.radioButton' all reuse
...
-- there's only ever one 'Blink.UI.Controls.Toggle.ToggleConfig' type -- none of the three
-- has its own -- so this isn't generic over a config type the way
-- 'Blink.UI.Controls.ButtonBehaviour.buttonBehaviourSpec' is.
module Blink.UI.Controls.ToggleBehaviour
  ( toggleBehaviourSpec
  ) where
...
import Blink.UI.Controls.ButtonBehaviour (buttonBehaviourSpec, defaultButtonBehaviourConfig)
import Blink.UI.Controls.Toggle (ToggleConfig, isSelected, onSelectedChanged)
import Blink.UI.Controls.Element (Attribute)
...
-- a change (see 'Blink.UI.Controls.Toggle.toggleBase'), or no 'SelectedChanged' at all
