...
module Blink.UI.Controls.ButtonSpec (spec) where

import qualified Data.Map.Strict as Map
import Test.Hspec

import Blink.UI.Controls.Button (ButtonConfig, button)
...
spec :: Spec
spec = describe "Blink.UI.Controls.Button" $ do
