module Blink.UI.Controls.ElementSpec (spec) where
...
import Blink.UI.Controls.ElementBehaviour (elementBehaviourSpec)
...
-- plus 'elementId' @eid@, discarding the 'Blink.UI.Controls.Element.ElementInteraction'
...
-- with @e@ and a plain label naming which one it was -- "Blink.UI.Controls.Element"
...
spec :: Spec
spec = describe "Blink.UI.Controls.Element.elementBase" $ do
