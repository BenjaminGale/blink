...
module Blink.UI.Controls.SliderSpec (spec) where

import qualified Data.Map.Strict as Map
import Test.Hspec

import Blink.UI.Controls.Control (isFocusable, onFocusGained, onFocusLost)
...
import Blink.UI.Controls.Slider (SliderConfig, onValueChanged, slider, step, value)
...
-- 'Blink.UI.Controls.Slider.slider's own hover\/drag thumb-shading formula,
...
-- | The horizontal margin 'Blink.UI.Controls.Slider.contentInset' leaves
...
spec :: Spec
spec = describe "Blink.UI.Controls.Slider" $ do
  ...
  describe "focus" $ do
    ...
    -- unfocused, the same starting point 'Blink.UI.Controls.ControlSpec's
