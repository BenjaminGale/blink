...
module Blink.UI.Controls.ToggleSpec (spec) where

import qualified Data.Map.Strict as Map
import Test.Hspec

import Blink.UI.Controls.Element (Attribute)
import Blink.UI.Controls.Toggle (ToggleConfig, isSelected, toggleButton, toggleChecked)
import Blink.UI.Controls.ToggleBehaviour (toggleBehaviourSpec)
...
-- | See 'Blink.UI.Controls.ButtonSpec.fullSize' -- same reasoning, for
-- 'toggleButton'.
...
spec :: Spec
spec = describe "Blink.UI.Controls.Toggle" $ do
