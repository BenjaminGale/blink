...
module Blink.UI.Controls.RadioButtonSpec (spec) where
...
import Blink.UI.Controls.Toggle (ToggleConfig, isSelected)
...
spec :: Spec
spec = describe "Blink.UI.Controls.RadioButton" $ do
