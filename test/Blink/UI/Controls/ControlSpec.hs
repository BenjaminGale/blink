...
module Blink.UI.Controls.ControlSpec (spec) where
...
-- via 'focusTargetOnClick' -- the same shape 'Blink.UI.Controls.Label.label'
...
spec :: Spec
spec = describe "Blink.UI.Controls.Control.controlBase" $ do
