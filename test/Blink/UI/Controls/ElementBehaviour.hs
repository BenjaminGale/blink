...
-- contract every 'Blink.UI.Controls.Element.elementBase'-based primitive must
-- satisfy. 'Blink.UI.Controls.ElementSpec' runs this against
-- 'Blink.UI.Controls.Element.elementBase' directly; anything built on top (a
...
-- that layer adds.
module Blink.UI.Controls.ElementBehaviour
...
-- | Tags every raw event a reaction built on 'Blink.UI.Controls.Element.elementBase'
