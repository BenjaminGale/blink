...
-- 'Blink.Controls.ButtonBehaviour.buttonBehaviourSpec'). 'Blink.Controls.ToggleButton.toggleButton',
...
-- there's only ever one 'Blink.Controls.ToggleButton.ToggleConfig' type -- none of the three
...
-- a change (see 'Blink.Controls.ToggleButton.toggleBase'), or no 'SelectedChanged' at all
