...
-- contract every 'Blink.Controls.Control.control'-based widget must
-- satisfy. 'Blink.Controls.ControlSpec' runs this against
-- 'Blink.Controls.Control.control' directly; every widget built on
