...
module Blink.View.Controls.SliderSpec (spec) where
...
-- | The horizontal margin 'Blink.View.Controls.Slider.contentInset' leaves
...
spec :: Spec
spec = describe "Blink.View.Controls.Slider" $ do
  ...
  describe "focus" $ do
    ...
    -- unfocused, the same starting point 'Blink.View.Controls.ControlSpec's
