...
module Blink.View.Controls.ToggleGroupSpec (spec) where
...
import Blink.View.Layout.Constraints (exactly, fill, height, width)
...
spec = describe "Blink.View.Controls.ToggleGroup" $ do
  ...
  -- 'Blink.View.Controls.Control.control', which watches its own
