...
module Blink.View.Controls.ProgressBarSpec (spec) where
...
import Blink.View.Controls.ProgressBar (ProgressBarConfig, ProgressValue (..), bandSpeed, progress, progressBar)
...
spec :: Spec
spec = describe "Blink.View.Controls.ProgressBar" $ do
