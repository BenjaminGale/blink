...
module Blink.View.Controls.TextInputSpec (spec) where
...
import Blink.View.Controls.TextInput
...
unfocused :: [Attribute'] -> View TestElement String ()
unfocused attrs = setFocus Other >> fullSizeTextInput Field attrs

spec :: Spec
spec = describe "Blink.View.Controls.TextInput" $ do
