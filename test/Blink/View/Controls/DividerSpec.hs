...
module Blink.View.Controls.DividerSpec (spec) where
...
import Blink.View.Controls.Divider (DividerConfig, divider, orientation, thickness)
...
import Blink.View.Layout.Constraints (align, exactly, width)
...
spec :: Spec
spec = describe "Blink.View.Controls.Divider" $ do
