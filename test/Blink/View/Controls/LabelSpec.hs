...
module Blink.View.Controls.LabelSpec (spec) where
...
import Blink.View.Controls.Label (LabelConfig, label, target, text)
...
spec :: Spec
spec = describe "Blink.View.Controls.Label" $ do
